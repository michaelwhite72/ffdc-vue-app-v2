      ...
      <div class="row advantages_grids">
        ...
        <div class="col-lg-6 mt-lg-0 mt-4">
          ...
          <p class="my-sm-4 my-3">
            ...
            maximus es blandit. Nam pretium tempor mi, a fringilla leo imperdiet
            intre. Integer lacini dolor ultricies turpis. non euismod lectus
            tincidunt vitae. Quisqe non facilis ante. Duis luctus id ex eget
            volutpat. Aliquam iaculis ante urn luctus viverra
          </p>
        </div>
